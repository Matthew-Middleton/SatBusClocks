...
*/
void SatCLKS::config_opts(unsigned int osc_clk_and_drive_opts, unsigned int counter_and_flags_opts, unsigned int clk_requests)
{
...
unsigned int SatCLKS::getClkSpeed(unsigned int clk)
{
